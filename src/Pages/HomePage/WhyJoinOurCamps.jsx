...
const benefits = [
  {
    ...
    icon: <FaHeartPulse  className="w-8 h-8 text-indigo-600" />,
  },
  {
    title: 'Qualified Doctors & Staff',
    description: 'All camps are run by certified medical professionals.',
    icon:<FaStethoscope className="w-8 h-8 text-indigo-600" />,
  },
  {
  ...
  },
  {
    ...
    icon:<IoShieldCheckmark className="w-8 h-8 text-indigo-600"/>,
  },
];

const WhyJoinOurCamps = () => {
  return (
    <section className="bg-gray-50 pb-20 px-4 md:px-8 lg:px-16">
